...
public class USLocalizer implements Localizer{
	...
	public static final double HIGH_ROTATION_SPEED = 150;			//Speed to rotate while distance > SPEED_BOUNDARY
	public static final double MAX_DISTANCE = 28;					//Distance at which to stop and latch angle
	public static final double SPEED_BOUNDARY = 11000000;					//Distance at which to switch speeds
